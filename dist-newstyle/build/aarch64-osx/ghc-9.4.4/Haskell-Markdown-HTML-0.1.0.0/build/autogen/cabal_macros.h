...
/* package Haskell-Markdown-HTML-0.1.0.0 */
#ifndef VERSION_Haskell_Markdown_HTML
#define VERSION_Haskell_Markdown_HTML "0.1.0.0"
#endif /* VERSION_Haskell_Markdown_HTML */
#ifndef MIN_VERSION_Haskell_Markdown_HTML
#define MIN_VERSION_Haskell_Markdown_HTML(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Haskell_Markdown_HTML */
...
#define CURRENT_PACKAGE_KEY "Haskell-Markdown-HTML-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "Haskell-Markdown-HTML-0.1.0.0-inplace"
